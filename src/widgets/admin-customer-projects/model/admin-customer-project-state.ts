...
export function applyAdminSearch<T extends string>(query: string, status?: T) {
  return { query, status, page: 1 };
}

export function getAdminQueryWarning(error: unknown, entity: string) {
